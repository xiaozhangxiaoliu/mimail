  ...
  <div class="detail">
    <div class="wrapper">
      <div class="container clearfix">
        ...
        <div class="content">
          <h2 class="item-title">{{ products.name }}</h2>
          <p class="item-info">
          ...
          <div class="item-price">
            {{ products.price }}元<span class="del">3999元</span>
          </div>
          <div class="line"></div>
          <div class="item-addr">
            <i class="icon-loc"></i>
          ...
          <div class="item-total">
            <div class="phone-info clearfix">
              ...
              <div class="fr">{{ products.price }}元</div>
            </div>
            <div class="phone-total">总计：{{ products.price }}元</div>
          </div>
          <div class="btn-group">
...
<script>
import Productparam from "../../../components/Home/productparam.vue";
import ServiceBar from "../../../components/Home/ServiceBar.vue";
import { swiper, swiperSlide } from "vue-awesome-swiper";
import "swiper/dist/css/swiper.css";
export default {
  components: { ServiceBar, Productparam, swiper, swiperSlide },
  data() {
    return {
      version: 1,
